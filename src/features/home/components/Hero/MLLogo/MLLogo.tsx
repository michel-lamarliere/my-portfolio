...
export function MLLogo({ className, onClick }: Props) {
  return (
    <div onClick={ onClick } style={ { display: "grid", placeItems: "center" } }>
      <svg
